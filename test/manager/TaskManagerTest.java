...
public abstract class TaskManagerTest<T extends TaskManager> {
    ...
    public void setUp() {
        ...
        Task task2 = new Task("Task2", "More information about task2", TaskStatus.NEW, Duration.ofMinutes(27), LocalDateTime.of(2025, 8, 5, 10, 38));
        Task task3 = new Task("Task3", "More information about task3", TaskStatus.NEW, Duration.ofMinutes(27), LocalDateTime.of(2025, 8, 6, 10, 39));
        ...
        Subtask subtask1 = new Subtask("Subtask1", "More information about subtask1", TaskStatus.NEW, epic1, Duration.ofMinutes(57), LocalDateTime.of(2025, 8, 7, 10, 47));
        Subtask subtask2 = new Subtask("Subtask2", "More information about subtask2", TaskStatus.NEW, epic1, Duration.ofHours(4), LocalDateTime.of(2025, 8, 8, 11, 2));
        Subtask subtask3 = new Subtask("Subtask3", "More information about subtask3", TaskStatus.NEW, epic1, Duration.ofHours(1), LocalDateTime.of(2025, 8, 9, 11, 7));
        Subtask subtask4 = new Subtask("Subtask4", "More information about subtask4", TaskStatus.DONE, epic2, Duration.ofHours(2), LocalDateTime.of(2025, 8, 10, 11, 17));
        Subtask subtask5 = new Subtask("Subtask5", "More information about subtask5", TaskStatus.NEW, epic3, Duration.ofMinutes(3), LocalDateTime.of(2025, 8, 11, 11, 21));
        Subtask subtask6 = new Subtask("Subtask6", "More information about subtask6", TaskStatus.NEW, epic3, Duration.ofMinutes(31), LocalDateTime.of(2025, 8, 12, 11, 35));
    ...
    @Test
    @DisplayName("Тест на конфликт времени у задач")
    void testNoCorrectTime() throws TaskIntersectException {
        Task newTask = new Task("NewTask", "More information about new task", TaskStatus.NEW, Duration.ofMinutes(47), LocalDateTime.of(2025, 8, 4, 10, 32));
        TaskIntersectException exception = assertThrows(TaskIntersectException.class,
                () -> taskManager.add(newTask),
                "Ожидалось исключение при пересечении времени задач");

        Assertions.assertTrue(exception.getMessage().contains("не может быть добавлена"),
                "Ожидалось исключение при пересечении времени задач");
    }

    @Test
    void TestTaskEqualsTask() { // проверьте, что экземпляры класса Task равны друг другу, если равен их id;
        Task taskTest = new Task("Task1", "More information about task1", TaskStatus.NEW, Duration.ofMinutes(47), LocalDateTime.of(2025, 8, 4, 20, 32));
    ...
    void TestUpdateStatusEpic() { // Проверка апгрейда статуса у Epic
        ...
        Assertions.assertTrue(taskManager.update(8, new Subtask("SubSub", "More information about sub", TaskStatus.DONE, (Epic) taskManager.get(4), Duration.ofMinutes(31), LocalDateTime.of(2025, 8, 4, 7, 35))));
        ...
        Assertions.assertTrue(taskManager.update(7, new Subtask("SubSub", "More information about sub", TaskStatus.DONE, (Epic) taskManager.get(4), Duration.ofMinutes(31), LocalDateTime.of(2025, 8, 4, 8, 35))));
        Assertions.assertTrue(taskManager.update(9, new Subtask("SubSub", "More information about sub", TaskStatus.DONE, (Epic) taskManager.get(4), Duration.ofMinutes(31), LocalDateTime.of(2025, 8, 4, 9, 35))));
